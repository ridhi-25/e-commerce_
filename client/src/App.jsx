    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', padding: 20 }}>
        <div className="glass-panel" style={{ maxWidth: 450, width: '100%', textAlign: 'center' }}>
          <h1 style={{ marginBottom: 15, background: 'linear-gradient(135deg, #a5b4fc 0%, #6366f1 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', letterSpacing: '-1px' }}>Apex Store</h1>
  ...
  return (
    <div style={{ minHeight: '100vh', paddingBottom: 60 }}>
      <nav className="navbar">
        <div className="nav-brand" style={{ cursor: 'pointer' }} onClick={() => setPage('home')}>Apex Store</div>
